...
time.sleep(3)
# Choose Number of Teams in pool 6 teams click
driver.execute_script("window.scrollTo({},{});".format(0, 200))
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/span/ul/li[5]").click()
time.sleep(2)
...
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/img").click()
time.sleep(1)
# No. of Pools  select 3  pools click
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/span/ul/li[2]").click()
time.sleep(1)
...
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/img").click()
time.sleep(1)
# Number of 3 Courts click
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/span/ul/li[2]").click()
# Number of 3  Courts  Next Button click
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[2]/button[2]/span").click()
time.sleep(1)
# Template Name click
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/label/input").click()
time.sleep(1)
# Template Name 6Teams3Pool3 Court send key
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/label/input").send_keys("6Teams3Pool3 Court")
time.sleep(1)
# Template Name 6Teams3Pool3 Court save click
