...
time.sleep(1)
# Template Name 8Teams3Pool3 Court send key
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/label/input").send_keys("8Teams3Pool3 Court")
time.sleep(1)
# Template Name 8Teams3Pool3 Court save click
