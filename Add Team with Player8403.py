...
# ref_code = driver.find_element_by_xpath("/html/body/div/div[2]/div[2]/div/div[3]/div[1]/div/div/div/div[7]/div[1]/div[2]/div/div/div[2]/div[2]/div[2]/div/div[4]/div/div/span/div[1]/div[2]/input").text
# print(ref_code)
...
# method= "function f(xpathToExecute){ var result = [];  var nodesSnapshot = document.evaluate(xpathToExecute, document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null ); for ( var i=0 ; i < nodesSnapshot.snapshotLength; i++ ){  result.push( nodesSnapshot.snapshotItem(i) );  }  return result;}"
# path=("/html/body/div/div[2]/div[2]/div/div[3]/div[1]/div/div/div/div[7]/div[1]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[3]")[0].textContent='Vishal'
# res_2 = js2py.eval_js ( method )
# print(res_2(path))
#
# #
...
#
# js2 = """function xpath(xpathToExecute){
#         var result = []
...
#     } xpath("/html/body/div/div[2]/div[2]/div/div[3]/div[1]/div/div/div/div[7]/div[1]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[3]")[0].textContent))
#     """.replace("document.write", "return ")
# result = js2py.eval_js(js2)

ref_code = driver.find_element_by_xpath("/html/body/div/div[2]/div[2]/div/div[3]/div[1]/div/div/div/div[7]/div[1]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[3]").text
