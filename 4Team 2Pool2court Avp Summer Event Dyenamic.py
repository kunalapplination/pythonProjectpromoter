...
# Login Button click
driver.find_element(By.XPATH, "/html/body/div/div[2]/div[2]/div/div[4]/div[3]/div").click()
time.sleep(2)
...
time.sleep(3)
# Choose Number of Teams in pool 4 teams click
driver.execute_script("window.scrollTo({},{});".format(0, 200))
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/div/a/div/span/ul/li[3]").click()
time.sleep(2)
...
time.sleep(1)
# Template Name 4T2Pool2court.,send key
driver.find_element(By.XPATH, "/html/body/div[2]/div/div[2]/div/div/div[1]/div/form/div[1]/div/label/input").send_keys("4T2Pool2court.,")
time.sleep(1)
# Template Name 4T2Pool2court., save click
