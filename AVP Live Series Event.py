...
driver.find_element(By.XPATH, "/html/body/div/div[2]/div[2]/div[2]/div[1]/div/div/div[2]/div[1]/div[2]/div/div[1]/input").send_keys("AVP Live Series")
...
#### for 24 Teams Open skill and A skills#####

driver.execute_script("window.scrollTo({},{});".format(0, 1200))
# Division Name 24Teams35+Open A
driver.find_element(By.XPATH, "/html/body/div[7]/div/div[2]/div/div/div/div/div/form/div[1]/div/a/div/span/ul/li[19]").click()
time.sleep(1)
# Division name done click
driver.execute_script("window.scrollTo({},{});".format(0, 100))
driver.find_element(By.XPATH, "/html/body/div[7]/div/div[2]/div/div/div/div/div/form/div[1]/div/a/div/span/ul/li[20]").click()
time.sleep(1)
...
time.sleep(1)
# Pools *  8Teams3Pool3 Courts click
driver.find_element(By.XPATH, "/html/body/div/div[2]/div[2]/div[2]/div[1]/div/div/div[10]/div[2]/div/div/div[4]/a/div/span/ul/li[24]").click()
time.sleep(1)
# Season * icon click
